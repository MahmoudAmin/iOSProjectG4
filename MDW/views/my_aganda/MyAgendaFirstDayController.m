...
#import "MyAgendaFirstDayController.h"

@interface MyAgendaFirstDayController ()
@property NSArray *sessions;

@end

@implementation MyAgendaFirstDayController
...
- (void)viewDidLoad {
    ...
    _sessions =[[JETSSessionModel new] getLikedSessionsAtDay:1];
}
