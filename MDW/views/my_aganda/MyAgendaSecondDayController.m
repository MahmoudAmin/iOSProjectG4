...
#import "MyAgendaSecondDayController.h"

@interface MyAgendaSecondDayController ()
@property NSArray *sessions;
@end

@implementation MyAgendaSecondDayController
...
- (void)viewDidLoad {
    ...
    _sessions =[[JETSSessionModel new] getLikedSessionsAtDay:2];
}
