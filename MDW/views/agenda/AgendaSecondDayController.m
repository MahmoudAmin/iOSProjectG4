...
#import "AgendaSecondDayController.h"

@interface AgendaSecondDayController ()
@property NSArray *sessions;
@end

@implementation AgendaSecondDayController
...
- (void)viewDidLoad {
    ...
    _sessions=[[JETSAgendaModel new] getDaySessions:2];
}
