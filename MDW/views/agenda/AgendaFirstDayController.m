...
#import "AgendaFirstDayController.h"

@interface AgendaFirstDayController ()
@property NSArray *sessions;

@end

@implementation AgendaFirstDayController
...
- (void)viewDidLoad {
    ...
    _sessions=[[JETSAgendaModel new] getDaySessions:1];
}
